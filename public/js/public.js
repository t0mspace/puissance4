...
var _interface = __webpack_require__(26);
...
$(document).ready(function () {
    ...
    _interface.gameInterface.createRedTokens();
    _interface.gameInterface.createYellowTokens();
    ...
    $('#grid td').droppable({
        ...
        drop: function drop(event, ui) {
            ...
            if ($(ui.draggable).hasClass('token-red')) {
                tokenColor = 'R';
                _game.game.nbrOfRedTokenPlayed++;
            } else if ($(ui.draggable).hasClass('token-yellow')) {
                tokenColor = 'Y';
                _game.game.nbrOfYellowTokenPlayed++;
            }

            // create new Token object
            var playedToken = new _Token.Token(tokenColor, col_index, row_index);

            //check if the played token is a winning shot
            if (_game.game.isAWinningShot(playedToken)) {
...
var gameInterface = exports.gameInterface = {
    createRedTokens: function createRedTokens() {
    ...
    createYellowTokens: function createYellowTokens() {
...
var game = exports.game = {
    ...
    isAWinningShot: function isAWinningShot(playedToken) {
        ...
        if (game.nbrOfRedTokenPlayed >= 4 || game.nbrOfYellowTokenPlayed >= 4) {
            ...
            return game.areTheSameTokenOnVertical(playedToken) || game.areTheSameTokenOnHorizontal(playedToken) || game.countSameTokenOnDiagGoesUpToDown(playedToken) || game.countSameTokenOnDiagGoesDownToUp(playedToken);
     ...
     * @returns {boolean}
     */
    areTheSameTokenOnVertical: function areTheSameTokenOnVertical(playedToken) {

        var totalOfNbreOfRows = 6;
        var positionOnRow = 0;
        var nbreSameToken = 0;
        ...
        for (var j = 1; j <= 4; j++) {
            if (playedToken.color !== this.gridOfPlayedTokenPosition[playedToken.row + 1][playedToken.column] || this.gridOfPlayedTokenPosition[playedToken.row + 1][playedToken.column] === 0) {
                break;
    ...
    areTheSameTokenOnHorizontal: function areTheSameTokenOnHorizontal(playedToken) {
        //let nbreSameTokenOnLeft = game.countSameTokenOnLeftOfPlayedToken(playedToken);
        // let nbreSameTokenOnRight = game.sameTokenInHorizontalOnLeft(playedToken)

        return game.countSameTokenOnLeftOfPlayedToken(playedToken) === 4 || game.countSameTokenOnRightOfPlayedToken(playedToken) === 4 || game.countSameTokenOnRightOfPlayedToken(playedToken) + game.countSameTokenOnRightOfPlayedToken(playedToken) === 4;
    },
     ...
     * @returns {number}
     */
    countSameTokenOnRightOfPlayedToken: function countSameTokenOnRightOfPlayedToken(playedToken) {
        ...
        for (var j = 0; j < 4; j++) {
            ...
            if (playedToken.color !== this.gridOfPlayedTokenPosition[playedToken.row][playedToken.column + 1] || this.gridOfPlayedTokenPosition[playedToken.row][playedToken.column + 1] === 0) {
     ...
     * @returns {number}
     */
    countSameTokenOnLeftOfPlayedToken: function countSameTokenOnLeftOfPlayedToken(playedToken) {
        ...
        console.log(playedToken.column);
        console.log('nbre of cells to check in horizontal left');
        var rowToCheck = playedToken.column;
        console.log(rowToCheck);
        for (var i = 0; i <= rowToCheck; i++) {
            ...
            if (playedToken.color !== this.gridOfPlayedTokenPosition[playedToken.row][playedToken.column - 1] || this.gridOfPlayedTokenPosition[playedToken.row][playedToken.column - 1] === 0 || this.gridOfPlayedTokenPosition[playedToken.row][playedToken.column - 1] === undefined) {
     ...
     * @returns {boolean}
     */
    countSameTokenOnDiagGoesDownToUp: function countSameTokenOnDiagGoesDownToUp(playedToken) {

        //check token on the left of the current played token
        console.log('START DIAG DOWN TO UP');
        console.log('*********');
        var positionOnColumn = 0;
        var nbreSameTokenDown = 0;
        var nbreSameTokenRight = 0;
        console.log('played token column');
        console.log(playedToken.column);
        ...
        for (var i = 1; i <= 4; i++) {
            ...
            //let previousColumn = playedToken.column-i;
            //console.log('previous column '+previousColumn);
            if (this.gridOfPlayedTokenPosition[playedToken.row + 1][playedToken.column - 1] === undefined || playedToken.color !== this.gridOfPlayedTokenPosition[playedToken.row + 1][playedToken.column - 1] || this.gridOfPlayedTokenPosition[playedToken.row + 1][playedToken.column - 1] === 0) {
                console.log('right: not the same color or not played');
                break;
        ...
        if (nbreSameTokenDown < 4) {
            ...
            for (var _i = 1; _i <= 4; _i++) {
                console.log('value of i ' + _i);
                console.log('current column ' + playedToken.column);
                //let previousColumn = playedToken.column-i;
                //console.log('previous column '+previousColumn);
                console.log(this.gridOfPlayedTokenPosition[playedToken.row - 1][playedToken.column + 1]);
                if (playedToken.color !== this.gridOfPlayedTokenPosition[playedToken.row - 1][playedToken.column + 1] || this.gridOfPlayedTokenPosition[playedToken.row - 1][playedToken.column + 1] === 0 || this.gridOfPlayedTokenPosition[playedToken.row - 1][playedToken.column + 1] === undefined) {
                    console.log('right: not the same color or not played');
                    break;
                } else if (playedToken.color === this.gridOfPlayedTokenPosition[playedToken.row - 1][playedToken.column + 1]) {
                    console.log('Same color on the left!');
     ...
     * @returns {boolean}
     */
    countSameTokenOnDiagGoesUpToDown: function countSameTokenOnDiagGoesUpToDown(playedToken) {
        //check token on the left of the current played token
        console.log('START DIAG UP TO DOWN');
        console.log('************************');
        var nbreSameTokenLeft = 0;
        var nbreSameTokenRight = 0;
        console.log('played token column');
        console.log(playedToken.column);
        ...
        for (var i = 0; i < 4; i++) {
            ...
            if (playedToken.row === 0) {
                break;
            } else if (this.gridOfPlayedTokenPosition[playedToken.row - 1][playedToken.column - 1] === 0 || playedToken.color !== this.gridOfPlayedTokenPosition[playedToken.row - 1][playedToken.column - 1]) {
                break;
            } else if (playedToken.color === this.gridOfPlayedTokenPosition[playedToken.row - 1][playedToken.column - 1]) {
                console.log('Same color on the left!');
...
var Token = exports.Token = function () {
    function Token(color, column, row) {
